...
def train_adaboost_dt(X_train, y_train):
    print("🚀 开始训练 AdaBoost（决策树版）模型...")
    try:
        ...
        print("✅ AdaBoost（决策树版）模型训练完成")
        return ada
    except Exception as e:
        print(f"❌ AdaBoost 模型训练失败：{e}")
        return None
